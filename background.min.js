...
d.send()},D=function(a){a.numResponses++;if(4===a.numResponses){var b=H(a.dictRes),c=b;"bn"!==p.language&&(c=H(a.enDictRes));var d=I(a.tranRes,!0),e=I(a.tabLangTranRes,!0),k=p.language.toLowerCase(),g=!1,n=null,l=null;e&&a.tabLang!==k?(g=!0,n=a.tabLangTranRes,l=e):!b&&d&&(g=!0,n=a.tranRes,l=d);g&&c&&c.audio&&"bn"===l.srcLang.toLowerCase()&&(l.audio=c.audio);c=g?"translation":"definition";b||l||(c="none");_gaq&&_gaq.push(["_trackEvent","lookup","type_"+c]);e=encodeURIComponent(a.sanitizedQuery);c=
"";g&&(c="http://translate.google.com/translate_t?source=dict-chrome-ex&sl="+l.srcLang+"&tl="+p.language+"&q="+e);d="http://www.google.com/search?source=dict-chrome-ex&defl="+p.language+"&hl="+p.language+"&q="+e+"&tbo=1&tbs=dfn:1";"n"===p.language&&(d="http://www.google.com/search?q=define+"+e);if("fetch_html"===a.request.type)b="",b=g?J(n,l.audio,c):K(a.dictRes,d),g={eventKey:a.request.eventKey,sanitizedQuery:a.sanitizedQuery,html:b};else{var h=null,t=null;g?(h=l,h.moreUrl=c):b&&(h=b,h.moreUrl=
...
K=function(a,b){if(!a||a.error)return"";a.moreUrl=b;a.makeAudioUrl=function(){var a=this.drEyeAudio;return a?L(a):""};var c={};a.showOnlyOnce=function(){return function(a,b){var k=b(a);if(c[k])return"";c[k]=!0;return k}};return q.browser_action_dict(a)},M=function(a){var b={};b.language=a.language||"bn";var c=function(c,d){var g=a[c];b[c]=d;"true"===g||"false"===g?b[c]=g:"boolean"===typeof g&&(b[c]=String(g))},d=function(c,d){b[c]=a[c]||d};c("popupDblclick","true");c("popupSelect","false");c("enableHttps",
